...
These should be prepared by FastSurferCNN post-processing.
"""
...
class VolumePrep(PipelineStage):
    ...
    name = "volume_prep"
    description = "Verify input files exist (prepared by FastSurferCNN)"
    
    def _run(self) -> None:
        """Verify required input files exist."""
        # Check orig.mgz (should be created by FastSurferCNN)
        ...
        # Check aparc+aseg.orig.mgz (should be created by FastSurferCNN)
        ...
        # Check mask.mgz (should be created by FastSurferCNN)
        ...
        # Check aseg.auto_noCCseg.mgz (should be created by FastSurferCNN)
