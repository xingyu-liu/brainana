...
def fix_roi_wm(
    ...
    if verbose:
        print(f"\n{'='*70}")
        print("Fixing V1 WM using template registration")
        print(f"{'='*70}\n")
    ...
    save_cropped_image(
        tpl_t1w_roi, tpl_new_affine, tpl_t1w_img.header, tpl_t1w_roi_f, verbose
    )
    save_cropped_image(
        tpl_seg_roi, tpl_new_affine, tpl_seg_img.header, tpl_seg_roi_f, verbose
    )
