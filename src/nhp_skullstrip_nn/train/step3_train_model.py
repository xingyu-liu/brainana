...
def main():
    ...
    if train_hdf5.exists() and val_hdf5.exists():
        ...
        print("  Training will use HDF5 mode for faster data loading")
    else:
        print("ℹ️  HDF5 datasets not found, will use file-based mode")
        print("   Run step1_split_data.py and step2_create_hdf5.py for faster training")
