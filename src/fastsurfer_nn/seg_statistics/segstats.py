...
from fastsurfer_nn.utils.arg_types import float_gt_zero_and_le_one as robust_threshold
from fastsurfer_nn.utils.arg_types import int_ge_zero as id_type
from fastsurfer_nn.utils.arg_types import int_gt_zero as patch_size_type
from fastsurfer_nn.utils.brainvolstats import Manager, MeasureTuple, read_measure_file
from fastsurfer_nn.utils.parser_defaults import add_arguments
...
def main(args: argparse.Namespace) -> Literal[0] | str:
    ...
    from fastsurfer_nn.utils.brainvolstats import ImageTuple, Manager, read_volume_file
    ...
    if save_maps:
        ...
        for name, dtype in zip(names, dtypes, strict=False):
            ...
            from fastsurfer_nn.data_loader.data_utils import save_image
...
# timeit cmd arg:
# python -m timeit <<EOF
# from fastsurfer_nn.segstats import main, make_arguments
