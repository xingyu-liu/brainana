...
model=/mnt/DataDrive3/xliu/monkey_training_groundtruth/nhp_skullstrip_nn_training/training_output/EPI_seg-brainmask_v1/checkpoints/best_model.pth
...
model=/home/star/github/nhp_mri_prep/macacaMRINN/pretrained_model/T2w_brainmask.pth
python -m macacaMRINN.scripts.run_prediction \
    --model $model \
    --input $input \
