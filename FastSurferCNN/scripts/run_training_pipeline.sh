...
# YAML_CONFIG=/home/star/github/banana/FastSurferCNN/config/FastSurferVINN_T1w_ARM2_coronal.yaml
YAML_CONFIG=/home/star/github/banana/FastSurferCNN/config/FastSurferVINN_EPI_brainmask_sagittal.yaml
