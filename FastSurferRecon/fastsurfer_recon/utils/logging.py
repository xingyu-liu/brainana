...
Matches FastSurferCNN logging format for consistency.
"""
...
def setup_logging(log_file_path: Path | str | None = None) -> None:
    """
    Set up logging using FastSurferCNN format.
    ...
    log_file_path : Path or str, optional
        ...
        console and file.
    """
    # Set up logging format (matches FastSurferCNN)
    ...
    # Get log level from environment (matches FastSurferCNN)
