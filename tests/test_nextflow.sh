...
# OUTPUT_DIR="/mnt/DataDrive3/xliu/prep_test/banana_test/preproc/dataset_easy_funcoreg_v1"
...
OUTPUT_DIR="/mnt/DataDrive2/macaque/data_preproc/macaque_mri/new_livingstone_test/preproc/bids_baby25_v1"
