...
from fastsurfer_nn.utils import logging, parser_defaults
...
from fastsurfer_nn.utils.parser_defaults import SubjectDirectoryConfig
...
class SubjectList:
    ...
    def __init__(
        ...
        flags : dict[str, Dict], optional
            ...
            `fastsurfer_nn.utils.parser_defaults.ALL_FLAGS`.
        **assign :
