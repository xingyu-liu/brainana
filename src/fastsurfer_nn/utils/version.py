...
def main(
    ...
    from fastsurfer_nn.utils.run_tools import MessageBuffer, Popen, PyPopen
...
def filter_git_status(git_process) -> str:
    ...
    Parameters
    ----------
    git_process : fastsurfer_nn.utils.run_tools.Popen
...
def read_and_close_version(project_file: TextIO | None = None) -> str:
    ...
    Notes
    -----
    See also fastsurfer_nn.version.read_version_from_project_file
    """
