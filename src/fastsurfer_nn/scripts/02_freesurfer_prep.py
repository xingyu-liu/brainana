...
# %%
# Test paths
common_dir = '/mnt/DataDrive3/xliu/prep_test/banana_test/preproc/surf_recon/MEBRAIN_amy_resue/mri'
...
ckpt_f = '/home/star/github/banana/fastsurfer_nn/pretrained_model/T1w_seg-ARM2_coronal.pkl'
