...
# func
model=/home/star/github/banana/NHPskullstripNN/pretrained_model/EPI_brainmask.pth
input=/mnt/DataDrive3/xliu/prep_test/banana_test/preproc/test_BC/func/input_BC.nii.gz
