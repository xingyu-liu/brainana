...
def fireants_registration(
    ...
    if xfm_type in ("rigid", "affine"):
        ...
        if compute_inverse:
            _invert_affine_mat(forward_mat, output_paths["inverse_transform"], logger)
