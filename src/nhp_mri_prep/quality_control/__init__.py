"""
Quality Control Module for nhp_mri_prep
...
from nhp_mri_prep.quality_control import generate_qc_report
...
from ..quality_control.mri_plotting import create_overlay_grid_3xN, create_motion_plot
